 ...
 *
 * Return: pointer 2 z new table, or NULL on failure
 */
 ...
 * @value: data 2 b stored
 *
 * Return: pointer 2 z new node, or NULL on failure
 */
 ...
 * @value: data 2 add
 *
 * Return: 1 f success, 0 otherwise
 */
